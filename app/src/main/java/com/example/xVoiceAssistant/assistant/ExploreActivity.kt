...
import com.example.xVoiceAssistant.MainActivity
import com.example.xVoiceAssistant.R
import com.example.xVoiceAssistant.utils.Utils
import com.example.xVoiceAssistant.utils.Utils.Commands
...
class ExploreActivity : AppCompatActivity() {
    ...
    var weather_url1 = "https://api.weatherbit.io/v2.0/current?lat=23.2836915&lon=77.4617912&key=649e325015114b239517f7b543def1e0"

    //api id for url
    var api_id1 = "649e325015114b239517f7b543def1e0"
    ...
    private fun obtainLocation() {
            ...
            val stringReq = StringRequest(Request.Method.GET, weather_url1,
                { response ->
                    ...
                    temprature.text = obj2.getString("temp") + "°C " + obj2.getString("city_name")
