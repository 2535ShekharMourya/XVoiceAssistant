...
import com.example.xVoiceAssistant.data.AssistantDatabase
import com.example.xVoiceAssistant.databinding.ActivityAssistantBinding
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.CAPTUREPHOTO
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.READCONTACTS
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.READSMS
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.REQUEST_CALL
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.REQUEST_CODE_SELECT_DOC
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.REQUEST_ENABLE_BT
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.SHAREAFILE
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.SHAREATEXTFILE
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.callContact
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.capturePhoto
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.clipBoardCopy
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.clipBoardSpeak
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.getDate
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.getTime
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.joke
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.makeAPhoneCall
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.motivationalThoughts
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.openFacebook
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.openGmail
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.openGoogle
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.openMaps
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.openMessages
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.openWhatsAPP
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.openYoutube
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.playRingtone
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.question
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.readSMS
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.search
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.sendSMS
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.shareAFile
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.shareATextMessage
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.speak
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.stopRingtone
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.turnOffFlash
import com.example.xVoiceAssistant.functions.AssistantFunctions.Companion.turnOnFlash
import com.example.xVoiceAssistant.functions.GoogleLensActivity
import com.example.xVoiceAssistant.utils.Utils.logKeeper
import com.example.xVoiceAssistant.utils.Utils.logSR
import com.example.xVoiceAssistant.utils.Utils.logTTS
   ...
   private lateinit var helper: OpenWeatherMapHelper
    ...
    override fun onBackPressed() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            val cy = binding.assistantConstraintLayout.height - getDips(44)
            val finalRadius: Int = Math.max(
                binding.assistantConstraintLayout.width,
                binding.assistantConstraintLayout.height
            )
